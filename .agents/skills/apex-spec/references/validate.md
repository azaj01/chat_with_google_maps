...
_N/A if session introduced no personal data handling._
...
_N/A if the session introduced no DB-layer changes._
...
_Skipped if no `.spec_system/CONVENTIONS.md` exists._
...
_N/A if session produced no application code._
