...
_The intersection of these three creates an identity that cannot be generic._
...
_Note: Omit this section only if the project is purely utilitarian (admin panels, internal tools). Even minimal consumer-facing products benefit from a brief._
